  ...
  return (
    <>
      <div className="Form-page-parent-container w-full min-h-[100vh] max-h-auto bg-gray-300 flex justify-center items-center">
        <div className="Form_page_from_container w-[100%] h-[auto] bg-white p-5 pt-2 lg:p-10 md:w-[90%] lg:w-[70%] rounded-2xl mt-[60px]">
          <form
          ...
          >
            ...
            <div className="register">
              ...
              />
              {errors.registerNo && (
                <p className="Error_message">{errors.registerNo.message}</p>
              )}
            </div>
            <div className="email">
